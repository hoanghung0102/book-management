...
<div class="container">
    ...
    <form:form method="POST" modelAttribute="bookForm" class="form-signin" action="create" style="margin:5% 35%">
        <h2 class="form-signin-heading" style="text-align: center">Book Registration</h2>
        <hr>
        ...
        <form:input type="hidden" path="createdAt" value="<%=new Timestamp(System.currentTimeMillis())%>"/>
